(function (a) {
    a.fn.particleText = function (p) {
        ...
        function g(r, q) {
            ...
            this.r = f.clientWidth / 1.5 * 0.003;//謨ｰ蟄励′螟ｧ縺阪￥縺ｪ繧九→邊貞ｭ舌�繧ｵ繧､繧ｺ縺悟ｰ上＆縺上↑繧�
        ...
        function h() {
            ...
            n = [];
            for (var t = 0; t < x; t += Math.round(x / 250)) {//邊貞ｭ舌�謨ｰ
                for (var s = 0; s < r; s += Math.round(x / 250)) {//邊貞ｭ舌�謨ｰ
                    if (u[(
                            (t + s * x) * 4
                        ) + 3] > 150) {
                        n.push(new g(t, s))
